...
![Landing Page](assets/images/SBRHP.png)
...
![Game Page](assets/images/SBRGP.png)
...
![About Section](assets/images/IconEnlarged.png)
...
![Footer](assets/images/SBRGPinGame.png)
...
![Rules button](assets/images/rulesbtn.png)
...
![Game over Screen Win](assets/images/playerwin.png)
![Game over Screen Lose](assets/images/spockwin.png)
![Game over Screen Draw](assets/images/draw.png)
...
- HTML
  - No errors were found when passing through the official [W3C validator](https://validator.w3.org/nu/?doc=https%3A%2F%2Fjmarabayev.github.io%2FSpockBeatsRock%2F)
- CSS
...
- Lighthouse Report 
    ...
    ![Lighthouse report](assets/images/lighthouseSBR.png)
-  Document edited and corrected according to JSHint. No Fatal errors, most occuring error relating to the code only being used in ES6
...
### Unfixed Bugs/Problems
 ...
 - Just before deployment I have lost all my progress and managed to recover it through copy pasting the code from browser history. Git commits were not registered properly on several occassions, my fault once, other times could have been an internal bug.
  ...
  - Was unable to do an array checking function for pattern detection.
...
The live link can be found here - https://jmarabayev.github.io/SpockBeatsRock/
